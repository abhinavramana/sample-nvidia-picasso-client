...
NVIDIA_USERNAME = os.getenv(
    "NVIDIA_USERNAME", "nvssa-prd-ky1kHS3yJ5uTSmZuAEKcaY83YtxJO0GnmxZGXlHT_OU"
)
...
NVCF_UPSCALER_FUNCTION_ID = os.getenv("NVCF_UPSCALER_FUNCTION_ID", "a345cc13-634d-4988-b516-8d86d7861537")
